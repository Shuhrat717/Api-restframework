...
from accounts.api.v1.permissions import IsOwnUserOrReadOnly
from accounts.api.v1.serializers import RegisterSerializer, LoginSerializer, AccountUpdateSerializer, \
